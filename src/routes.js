...
const routes = [
  ...
  { path: '/gam/inplementacao-operacional', name: 'Implementações Operacionais', element: ImplementacaoIntegracaoGam },
  { path: '/gam/inplementacao-integração', name: 'Implementações de Integração', element: ImplementacaoOperacionalGam },
