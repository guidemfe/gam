...
const BadgeForViabilidadesTecnicas = ({ selectedPercentage, setSelectedPercentage }) => {
  useEffect(() => {
...
BadgeForViabilidadesTecnicas.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(BadgeForViabilidadesTecnicas);
